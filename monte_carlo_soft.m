function [vx,time_out,first_passage_time,state,velo,amplitude] = ...
    monte_carlo_soft(ns,M,C,K,alpha,q,mass,damping,stiffness,fmax_ps,nonstat,...
    is_base, T, dT, bar, S0) 
    ...
    parfor i=1:ns
        ...
        [t1,X] = fde45_mdof_new(@(t,x,w) fun_fde_mdof_soft(t,x,ndof,MiC,MiK,Mi,...
            mass,damping,stiffness,alpha,is_base,w), tt, xini, q, wv);
