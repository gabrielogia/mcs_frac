function [tt,response_frac] = fde45_mdof_bw(fun,tspan,x0,q,wv)
    tt = tspan;
    N = numel(tspan);
    n = numel(x0);
    ndof =  round(n / 4);
    ...
    for i=1:length(tt)-1
        ...
        for ii=1:ndof
            ...
            response_frac(3*ndof+ii,i+1) = frac_der(ii,i+1);
        end
    end