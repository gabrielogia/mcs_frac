...
print(fig,'plots/equivalent_stiffness_and_beta_different_q_soft','-dpng','-r1000')
...
set(fig,'papersize',[6.0 5.5], 'Position',[200 200 900 550]);
print(fig,'plots/survival_prop_soft','-dpng','-r1000')
    ...
    if(contains(files(i).name, str0) && contains(files(i).name, str1) && contains(files(i).name, str2) && ...
        ...
        if (str2double(str_split(7)) == q)
            ...
            for j = 1:1:ndof
                ...
                plot3(time_out,ones(size(time_out))*0.0044,ha,'r','linewidth',2)
                plot3(time_out,ones(size(time_out))*0.0087,ha,'--r','linewidth',2)
                plot3(time_out,ones(size(time_out))*0.0131,ha,':r','linewidth',2)
                clim([0, 300])
                ylim([0, 0.03])
                xlim([0 4])
                xticks([0 1 2 3 4])
                ...
                plot3(time_out,ones(size(time_out))*0.0044,ha,'r','linewidth',2) %0.0070, 0.0141, 0.0211
                plot3(time_out,ones(size(time_out))*0.0087,ha,'--r','linewidth',2) %0.0070, 0.0141, 0.0211
                plot3(time_out,ones(size(time_out))*0.0131,ha,':r','linewidth',2) %0.0070, 0.0141, 0.0211
                clim([0, 300])
                ylim([0, 0.03])
                xlim([0 4])
                xticks([0 1 2 3 4])
...
set(fig,'papersize',[6.0 5.5], 'Position',[200 200 900 550]);
print(fig,'plots/amplitude_pdf_soft','-dpng','-r1000')